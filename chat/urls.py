...
from chat.views import UploadFile, CreatePrivateChatRoom, CreateGroupChatRoom, HandleGroupChat, FetchChatroomMessages, UserChatList
urlpatterns = [
    ...
    path("fetch-chat-list/", UserChatList.as_view(), name="user-chat-list"),
]